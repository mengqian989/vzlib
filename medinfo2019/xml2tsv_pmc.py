...
# log file
logging.basicConfig(filename='.xml2tsv_pmc.log',
                    level=logging.DEBUG, filemode='w')

# arguments
parser = argparse.ArgumentParser()
parser.add_argument("--input", default='data/brca_pmc.xml.gz',
                    help="input file (default: "
                    "data/brca_pmc.xml.gz)")
parser.add_argument("--med", default='brca_med_top4.txt',
